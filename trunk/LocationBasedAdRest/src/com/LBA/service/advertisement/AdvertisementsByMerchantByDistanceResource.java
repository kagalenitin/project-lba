 ...
 * @author payalpatel
 */
public class AdvertisementsByMerchantByDistanceResource extends BaseResource {
	...
	protected void doInit() throws ResourceException {
		...
		this.adName = (String) getRequest().getAttributes().get("adName");
	...
	public DomRepresentation toXml() {
		...
		try {
			...
			ArrayList<AdMerchantAdBean> advertisements = advertisementModel
					.getAdsbyMerchantNearBy(adName, latitude, longitude);
