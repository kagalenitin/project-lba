...
/**
 * This class manages the image for the home page of the application.
 * 
 * @author payal
 * 
 */
public class ImageAdapter extends BaseAdapter {
	...
	R.drawable.largetiles48, R.drawable.ic_menu_mylocation, R.drawable.user_48,
			R.drawable.topview48, R.drawable.category_forum_old,
			R.drawable.ic_menu_directions, R.drawable.shopping_bag,
			R.drawable.feed_icon_grey_48px, R.drawable.forum_old_48 };
